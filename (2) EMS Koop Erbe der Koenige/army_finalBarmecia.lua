...
function ActivateBarmeciaFinal1()
				...
				if Counter.Tick2("BarFAttack1", RespawnBarF) then
					for i = 1, 4 do
						SetEntityName(AI.Entity_CreateFormation(3, BarSwordFTable[1], nil, BarSwordFTable[2], SpawnPos.X, SpawnPos.Y, 0, 1, 3
							, 0), "SwordBarF" .. i)
						AddWaypoints("SwordBarF" .. i, { "FolkDef3" })
						AddWaypoints("SwordBarF" .. i, { "Serfs_Id14" })
						AddWaypoints("SwordBarF" .. i, { "Serfs_Id12" })
				...
				if Counter.Tick2("BarFAttack2", RespawnBarF) then
					for i = 1, 4 do
						SetEntityName(AI.Entity_CreateFormation(3, BarBowFTable[1], nil, BarBowFTable[2], SpawnPos.X, SpawnPos.Y, 0, 1, 3
							, 0), "BowBarF" .. i)
						AddWaypoints("BowBarF" .. i, { "FolkDef3" })
						AddWaypoints("BowBarF" .. i, { "Serfs_Id14" })
						AddWaypoints("BowBarF" .. i, { "Serfs_Id12" })
				...
				if Counter.Tick2("BarFAttack3", RespawnBarF) then
					for i = 1, 2 do
						SetEntityName(AI.Entity_CreateFormation(3, BarCanon1FTable[1], nil, BarCanon1FTable[2], SpawnPos.X, SpawnPos.Y, 0, 1, 3
							, 0), "Canon1BarF" .. i)
						AddWaypoints("Canon1BarF" .. i, { "FolkDef3" })
						AddWaypoints("Canon1BarF" .. i, { "Serfs_Id14" })
						AddWaypoints("Canon1BarF" .. i, { "Serfs_Id12" })
					end
				end
			end
		end
				...
				if Counter.Tick2("BarFAttack4", RespawnBarF) then
					for i = 1, 2 do
						SetEntityName(AI.Entity_CreateFormation(3, BarCanon2FTable[1], nil, BarCanon2FTable[2], SpawnPos.X, SpawnPos.Y, 0, 1, 3
							, 0), "Canon2BarF" .. i)
						AddWaypoints("Canon2BarF" .. i, { "FolkDef3" })
						AddWaypoints("Canon2BarF" .. i, { "Serfs_Id14" })
						AddWaypoints("Canon2BarF" .. i, { "Serfs_Id12" })
					end
				end
			end
		end
			...
			if IsDestroyed("CavBarF1") and IsDestroyed("CavBarF2") and IsDestroyed("CavBarF3") then
				if Counter.Tick2("BarFAttack5", RespawnBarF) then
					for i = 1, 3 do
						SetEntityName(AI.Entity_CreateFormation(3, BarSwordFTable[1], nil, BarSwordFTable[2], SpawnPos.X, SpawnPos.Y, 0, 1, 3
							, 0), "CavBarF" .. i)
						AddWaypoints("CavBarF" .. i, { "FolkDef3" })
						AddWaypoints("CavBarF" .. i, { "Serfs_Id14" })
						AddWaypoints("CavBarF" .. i, { "Serfs_Id12" })
...
function ActivateFolklungFinal1()
...
function ActivateOutpostFinal1()
