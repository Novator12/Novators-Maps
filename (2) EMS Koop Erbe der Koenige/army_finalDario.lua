...
function ActivateBarmeciaFinal3()
...
function ActivateFolklungFinal3()
...
function ActivateOutpostFinal3()
				...
				if Counter.Tick2("DarAttack1", RespawnDar) then
					for i = 1, 3 do
						SetEntityName(AI.Entity_CreateFormation(7, DarSwordTable[1], nil, DarSwordTable[2], SpawnPos.X, SpawnPos.Y, 0, 1, 3
							, 0), "DarSword1_" .. i)
						AddWaypoints("DarSword1_" .. i, { "FolkOutpostDef1" })
						AddWaypoints("DarSword1_" .. i, { "FolkOutpostDef2" })
						AddWaypoints("DarSword1_" .. i, { "FolkDef2" })
			...
			if IsDestroyed("DarSword2_1") and IsDestroyed("DarSword2_2") and IsDestroyed("DarSword2_3") then
				if Counter.Tick2("DarAttack2", RespawnDar) then
					for i = 1, 3 do
						SetEntityName(AI.Entity_CreateFormation(7, DarSwordTable[1], nil, DarSwordTable[2], SpawnPos.X, SpawnPos.Y, 0, 1, 3
							, 0), "DarSword2_" .. i)
						AddWaypoints("DarSword2_" .. i, { "FolkOutpostDef1" })
						AddWaypoints("DarSword2_" .. i, { "FolkOutpostDef2" })
						AddWaypoints("DarSword2_" .. i, { "FolkDef2" })
				...
				if Counter.Tick2("DarAttack3", RespawnDar) then
					for i = 1, 3 do
						SetEntityName(AI.Entity_CreateFormation(7, DarBowTable[1], nil, DarBowTable[2], SpawnPos.X, SpawnPos.Y, 0, 1, 3
							, 0), "DarBow1_" .. i)
						AddWaypoints("DarBow1_" .. i, { "FolkOutpostDef1" })
						AddWaypoints("DarBow1_" .. i, { "FolkOutpostDef2" })
						AddWaypoints("DarBow1_" .. i, { "FolkDef2" })
			...
			if IsDestroyed("DarBow2_1") and IsDestroyed("DarBow2_2") and IsDestroyed("DarBow2_3") then
				if Counter.Tick2("DarAttack4", RespawnDar) then
					for i = 1, 3 do
						SetEntityName(AI.Entity_CreateFormation(7, DarBowTable[1], nil, DarBowTable[2], SpawnPos.X, SpawnPos.Y, 0, 1, 3
							, 0), "DarBow2_" .. i)
						AddWaypoints("DarBow2_" .. i, { "FolkOutpostDef1" })
						AddWaypoints("DarBow2_" .. i, { "FolkOutpostDef2" })
						AddWaypoints("DarBow2_" .. i, { "FolkDef2" })
				...
				if Counter.Tick2("DarAttack5", RespawnDar) then
					for i = 1, 3 do
						SetEntityName(AI.Entity_CreateFormation(7, DarCavTable[1], nil, DarCavTable[2], SpawnPos.X, SpawnPos.Y, 0, 1, 3
							, 0), "DarCav" .. i)
						AddWaypoints("DarCav" .. i, { "FolkOutpostDef1" })
						AddWaypoints("DarCav" .. i, { "FolkOutpostDef2" })
						AddWaypoints("DarCav" .. i, { "FolkDef2" })
				...
				if Counter.Tick2("DarAttack6", RespawnDar) then
					for i = 1, 3 do
						SetEntityName(AI.Entity_CreateFormation(7, DarCanTable[1], nil, DarCanTable[2], SpawnPos.X, SpawnPos.Y, 0, 1, 3
							, 0), "DarCan" .. i)
						AddWaypoints("DarCan" .. i, { "FolkOutpostDef1" })
						AddWaypoints("DarCan" .. i, { "FolkOutpostDef2" })
						AddWaypoints("DarCan" .. i, { "FolkDef2" })
					end
				end
			end
		end
