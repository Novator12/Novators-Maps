---GFX-Sets für dem Tag Nacht Zyklus Sommertag changed by Novator12, created by Ghoul
  ...
  AddRain = function(dauer)
    ...
    AddNightRain = function(dauer)
		Logic.AddWeatherElement(2, dauer, 0, 13, 5, 15)
	end
     ...
     AddSunriseRain = function(dauer)		
		Logic.AddWeatherElement(2, dauer, 0, 14, 5, 15)		
	 end
     ...
     AddTransitionSunriseRain = function(dauer)		
		Logic.AddWeatherElement(2, dauer, 0, 15, 5, 15)		
	 end
